...
public class Engine {
    ...
    public static void launchGame(String gameRules, String[][] questionsAnswer) {
        ...
        for (String[] strings : questionsAnswer) {
            ...
            System.out.println(STR."Question: \{strings[QUESTIONS_NUMBER]}");
            System.out.print("Your answer: ");
            var currentAnswer = console.nextLine();
            if (!currentAnswer.equals(correctAnswer)) {
                System.out.println(STR."'\{currentAnswer}' is wrong answer ;(. Correct answer was '\{correctAnswer}'. Let's try again, \{username}!");
                return;
            }
            System.out.println("Correct!");
        }
        System.out.println(STR."Congratulations, \{username}!");
    }
}
